...
export const CreateVM = call('CreateVM', (artifactDigest, vcpus, memoryMiB, imageReference = '') => webRequest('/vms', { method: 'POST', body: JSON.stringify({ artifactDigest, imageReference, vcpus, memoryMiB }) }))
