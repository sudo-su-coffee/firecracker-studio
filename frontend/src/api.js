...
export const Health = call('Health', () => Promise.reject(new Error('Connect a Firecracker worker to load data')))
...
export const Convert = call('Convert', () => Promise.reject(new Error('Connect a Firecracker worker before converting images')))
export const CreateVM = call('CreateVM', () => Promise.reject(new Error('Connect a Firecracker worker before creating microVMs')))
