...
const latestOperation = computed(() => data.operations[data.operations.length - 1])
...
<template>
  <div class="desktop-shell">
    <aside class="sidebar">
      ...
      <div class="sidebar-bottom"><small>v1.0.8 · BlackLoverTech</small></div>
    </aside>
